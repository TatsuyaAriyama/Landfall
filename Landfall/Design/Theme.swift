...
enum LFColor {
    ...
    static let harborTeal = Color(hex: 0x184A40)   // Aftide アイコン背景(既定)
    static let harborSand = Color(hex: 0xEADEBD)   // Aftide アイコン前景(帆と陸)
    static let emberGold = Color(hex: 0xF3C065)    // Aftide 暖色版の前景
}
