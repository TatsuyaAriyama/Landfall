// Apple PKI (https://www.apple.com/certificateauthority/) が公開する
// DER形式の Apple Root CA - G2 / G3。App Store Server Libraryの署名検証に使う。
// 更新時は公式PKIページのフィンガープリントと照合すること。

function der(base64: string): Buffer {
