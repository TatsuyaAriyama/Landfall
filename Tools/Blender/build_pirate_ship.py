...
def build() -> None:
    ...
    kit.mesh_object("Hull_Topsides", hull_vertices, topside_faces, mats["hull"], root, objects)
    kit.mesh_object("Hull_Bottom", hull_vertices, bottom_faces, mats["tar"], root, objects)
