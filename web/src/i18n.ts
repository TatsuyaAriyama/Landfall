...
const ja = {
  ...
  signInNetworkFailed:
    "通信を確認できませんでした。回線を確認して、もう一度お試しください。",
  signInNotConfigured:
    "このWeb版のサインイン設定を確認できませんでした。サポートに連絡してください。",
  today: "ホーム",
  playerIslandName: "{name}の島",
  islandMenuSubtitle: "島を築き、歩く",
  harborMenuSubtitle: "仲間と出会う",
  logbookMenuSubtitle: "航海の記録を読む",
  styleMenuSubtitle: "船乗りの装いを変える",
  help: "ヘルプ",
  helpIntro: "航海の基本を、いつでもここで確認できます。",
  helpItemsBody: "作業項目を選ぶと航海が始まります。名前を押すと編集できます。",
  helpDestinationsBody: "島を目的地にして、記録を重ねながら少しずつ近づきます。",
  helpLogbookBody: "毎日の記録と航海誌を振り返れます。",
  helpHarborBody: "港で仲間と合流し、一緒に航海できます。",
  trace: "軌跡",
  harbor: "港",
  signOut: "サインアウト",
  ...
  workItemsSettings: "作業項目",
  workItemsSettingsHint: "名前・色・シンボル・並び順を、ここで落ち着いて変更できます。",
  workItemsCount: "{count}件の作業項目",
  editNamedItem: "{name}を編集",
  harborControlsSettings: "移動スティック",
  harborControlsSettingsHint:
    "港で航海士を動かすスティックです。海の画面を押したまま動かして配置を決められます。",
  harborControlsSettingsSummary: "位置と大きさを変更",
  harborControlsPlacement: "移動スティックの配置プレビュー",
  harborControlsDrag: "押したまま、好きな位置へ",
  harborControlsSize: "大きさ",
  harborSailingControls: "船の左右移動",
  harborSteerLeft: "船を左へ動かす",
  harborSteerRight: "船を右へ動かす",
  harborSailingSteer: "操船",
  harborSection: "港",
  small: "小さく",
  large: "大きく",
  restoreDefault: "初期位置に戻す",
  record: "記録する",
  minutesLabel: "時間(分)",
  minutesUnit: "分",
  ...
  voyageComplete: "航海を終えました。",
  completedWork: "作業内容",
  completedTotal: "合計時間",
  returnHome: "ホームに戻る",
  todayTotalLabel: "合計 {time}",
  todaysLog: "今日の記録",
  ...
  stepsProgress: "{done} / {total} 完了",
  stepsLimit: "{count} / {max} ステップ",
  stepsReady: "すべて完了。上陸できます。",
  ...
  breakLabel: "休憩",
  bgm: "BGM",
  voyagePlaylist: "航海プレイリスト",
  selectTrack: "曲を選択",
  soundOff: "音なし",
  soundOffSubtitle: "無音で航海",
  soundWaves: "波音",
  soundWavesSubtitle: "環境音",
  soundHarborMinuet: "港のメヌエット",
  soundBeaconRondo: "灯標のロンド",
  soundCelestialNocturne: "天測のノクターン",
  soundApproachingEvolution: "迫る進化",
  originalSoundtrack: "オリジナルサウンドトラック",
  timerFinish: "終了",
  ...
  voyagePassDescription:
    "季節の海域や航海士の装いなど、KeelMiraの世界をさらに広げるための航海証です。",
  ...
  voyagePassActive: "有効",
  voyagePassActiveDescription: "航海証を携えています。KeelMiraの特別な海域を航行できます。",
  voyagePassGet: "航海証を購入",
  ...
  dark: "ダーク",
  music: "音楽",
  homeBackgroundMusic: "港のメヌエット",
  harborMinuetSummary: "KeelMiraのメインテーマ · タイマー以外の画面で流れます。",
  waveAmbience: "波の音",
  waveAmbienceSummary: "穏やかな波音 · テーマ曲と一緒に流せます。",
  musicOn: "オン",
  musicOff: "オフ",
  account: "アカウント",
...
const en: Record<I18nKey, string> = {
  ...
  signInNotConfigured:
    "Sign-in is not configured correctly for this web build. Please contact support.",
  today: "Home",
  playerIslandName: "{name}'s Island",
  islandMenuSubtitle: "Build and explore",
  harborMenuSubtitle: "Meet the crew",
  logbookMenuSubtitle: "Read your voyage records",
  styleMenuSubtitle: "Change your look",
  help: "Help",
  helpIntro: "Review the essentials of your voyage whenever you need them.",
  helpItemsBody: "Choose an item to begin a voyage. Select its name to edit it.",
  helpDestinationsBody: "Set an island as your destination and move closer with every record.",
  helpLogbookBody: "Look back on daily records and your voyage journal.",
  helpHarborBody: "Meet your crew in the harbor and sail together.",
  trace: "Trace",
  harbor: "Harbor",
  signOut: "Sign out",
  ...
  workItemsSettings: "Work items",
  workItemsSettingsHint: "Change names, colors, symbols, and ordering here without starting a voyage.",
  workItemsCount: "{count} work items",
  editNamedItem: "Edit {name}",
  harborControlsSettings: "Movement stick",
  harborControlsSettingsHint:
    "Move the stick anywhere on the harbor preview, then choose a comfortable size.",
  harborControlsSettingsSummary: "Change position and size",
  harborControlsPlacement: "Movement stick placement preview",
  harborControlsDrag: "Hold and drag anywhere",
  harborControlsSize: "Size",
  harborSailingControls: "Move the boat sideways",
  harborSteerLeft: "Steer left",
  harborSteerRight: "Steer right",
  harborSailingSteer: "Steer",
  harborSection: "Harbor",
  small: "Smaller",
  large: "Larger",
  ...
  voyageComplete: "Voyage complete.",
  completedWork: "Work completed",
  completedTotal: "Total time",
  returnHome: "Return home",
  todayTotalLabel: "Total {time}",
  ...
  stepsProgress: "{done} / {total} completed",
  stepsLimit: "{count} / {max} steps",
  stepsReady: "All steps complete. You can go ashore.",
  stepsCount: "{done} / {total}",
  ...
  breakLabel: "Break",
  bgm: "BGM",
  voyagePlaylist: "Voyage playlist",
  selectTrack: "Select track",
  soundOff: "Sound off",
  soundOffSubtitle: "Sail in silence",
  soundWaves: "Waves",
  soundWavesSubtitle: "Ambient sound",
  soundHarborMinuet: "Harbor Minuet",
  soundBeaconRondo: "Beacon Rondo",
  soundCelestialNocturne: "Celestial Navigation Nocturne",
  soundApproachingEvolution: "Approaching Evolution",
  ...
  voyagePassDescription:
    "Your pass to seasonal seas, navigator attire, and more of the KeelMira world.",
  ...
  voyagePassActiveDescription:
    "Your Voyage Pass is aboard. Special waters of KeelMira are open to you.",
  voyagePassGet: "Purchase Voyage Pass",
  ...
  dark: "Dark",
  music: "Music",
  homeBackgroundMusic: "Harbor Minuet",
  harborMinuetSummary: "KeelMira main theme · plays outside the timer.",
  waveAmbience: "Wave ambience",
  waveAmbienceSummary: "Gentle waves · can play together with the theme.",
  musicOn: "On",
  musicOff: "Off",
  account: "Account",
...
export function inviteShareLine(name: string, code: string): string {
  return lang === "ja"
    ? `KeelMiraの港「${name}」に招待されました。コード: ${code}`
    : `You're invited to the harbor "${name}" on KeelMira. Code: ${code}`;
}
